...
static void DrawContext_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/DrawContext.uno");
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[27/*string*/]))
    {
        ...
        return ::g::Fuse::JSFileSource::New1(uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[9/*Fuse.IObject*/]), ::STRINGS[24/*"path"*/]), ::TYPES[27/*string*/]));
...
{
    ::STRINGS[25] = uString::Const("Attempted to allocate ");
    ::STRINGS[26] = uString::Const("x");
    ::STRINGS[27] = uString::Const(" framebuffer, max is ");
    ::STRINGS[28] = uString::Const("framebuffer pinned while app going into the background");
    ::STRINGS[29] = uString::Const("Pool is leaking");
...
void FramebufferPoolImpl__FuseResourcesISoftDisposableSoftDispose_fn(FramebufferPoolImpl* __this)
{
    ...
    for (int i = 0; i < uPtr(__this->cacheFramebuffers)->Count(); i++)
    {
        ...
        if (uPtr(c)->IsPinned())
            U_THROW(::g::Uno::Exception::New2(::STRINGS[28/*"framebuffer...*/]));
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[25/*"Attempted t...*/], uBox<int>(::TYPES[41/*int*/], width)), ::STRINGS[26/*"x"*/]), uBox<int>(::TYPES[41/*int*/], height)), ::STRINGS[27/*" framebuffe...*/]), uBox<int>(::TYPES[41/*int*/], maxSize)), ::STRINGS[26/*"x"*/]), uBox<int>(::TYPES[41/*int*/], maxSize))));
...
void FramebufferPoolImpl::Update()
{
    ...
    for (int i = 0; i < uPtr(framebufferPool)->Count(); i++)
    {
        ...
        if (framesSinceUse < 0)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[29/*"Pool is lea...*/]));
...
static void ILoadingStatic__cctor__fn(uType* __type)
{
    ...
    ILoadingStatic::IsLoadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[30/*"IsLoading"*/]);
}

static void ILoadingStatic_build(uType* type)
{
    ::STRINGS[30] = uString::Const("IsLoading");
    type->SetFields(0,
...
{
    ::STRINGS[31] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[38] = uString::Const("true");
    ::STRINGS[39] = uString::Const("false");
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[9/*Fuse.IObject*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[31/*"Json.String...*/]));
    ...
    else if (uIs(value, ::TYPES[47/*Fuse.IArray*/]))
    {
        ...
        uPtr(sb)->Append2(::STRINGS[37/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[38/*"true"*/];
    else
        return ::STRINGS[39/*"false"*/];
}
...
::g::Uno::UX::Size2 Marshal::StringToSize2(uString* o)
{
    ...
    if (::g::Uno::String::Contains(uPtr(o), ::STRINGS[33/*","*/]))
    {
...
bool Marshal::ToBool(uObject* v)
{
    ...
    else if (uIs(v, ::TYPES[27/*string*/]))
    {
        ...
        if (::g::Uno::String::op_Equality(s, ::STRINGS[38/*"true"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, uString::Const("True")))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[39/*"false"*/]))
            return false;
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[40/*"Cannot conv...*/], o), uString::Const("' to target type '")), t), ::STRINGS[42/*"'"*/]), diagnosticSource, uString::Const("/usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/Marshal.Convert.uno"), 103, uString::Const("TryConvertTo"), NULL);
...
void NodeGroupBase::AddContent()
{
    ...
    _addedNodes = uArray::New(::TYPES[68/*Fuse.Node[]*/], addedNodesCount);
    int addedNodesAt = 0;
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/iOSDevice.uno
// -------------------------------------------------------------
...
{
    return *__retval = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition(uBox<int>(::TYPES[41/*int*/], __this->Major), ::STRINGS[46/*"."*/]), uBox<int>(::TYPES[41/*int*/], __this->Minor)), ::STRINGS[46/*"."*/]), uBox<int>(::TYPES[41/*int*/], __this->Patch)), void();
}
...
static void PlacedArgs_build(uType* type)
{
    ...
    ::STRINGS[49] = uString::Const("width");
    ::STRINGS[50] = uString::Const("height");
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[26/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[48/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[49/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[50/*"height"*/], (double)NewSize().Y);
}
...
static void PreviewState_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[60/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/], offsetof(PreviewState, _savers), 0);
}
...
{
    _savers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[60/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/]));
}
...
PreviewState* PreviewState::Find(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        ::g::Fuse::RootViewport* rv = uAs< ::g::Fuse::RootViewport*>(n, ::TYPES[61/*Fuse.RootViewport*/]);
...
// /usr/local/share/uno/Packages/Fuse.iOS/1.4.2/iOSApp.uno
// -------------------------------------------------------
...
static void RootViewport_build(uType* type)
{
    ...
    ::TYPES[23] = ::g::Uno::EventHandler_typeof();
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[64] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[65] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[66] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ...
    type->SetInterfaces(
        ...
        ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(RootViewport_type, interface10),
    ...
    type->SetFields(65,
        ::TYPES[63/*Fuse.IFrame*/], offsetof(RootViewport, _frame), 0,
        ...
        ::TYPES[67/*Uno.Action<float2>*/], offsetof(RootViewport, Resized1), 0);
}
...
{
    for (::g::Fuse::Visual* v = (::g::Fuse::Visual*)__this->FirstChild(::TYPES[64/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (::g::Fuse::Visual*)uPtr(v)->NextSibling(::TYPES[65/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
        uPtr(v)->Draw(dc);
}
...
void RootViewport__UnoIDisposableDispose_fn(RootViewport* __this)
{
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(__this->Children()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/]));
}
...
void RootViewport::ctor_4(uObject* frame)
{
    ...
    ctor_2();
    _frame = frame;
    ::g::Fuse::IFrame::add_FrameChanged(uInterface(uPtr(_frame), ::TYPES[63/*Fuse.IFrame*/]), uDelegate::New(::TYPES[23/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
...
void RootViewport::EstablishSizeInternals()
{
    ...
    _pixelSize = ::g::Fuse::IFrame::Size(uInterface(uPtr(_frame), ::TYPES[63/*Fuse.IFrame*/]));
...
{
    ::TYPES[68] = ::g::Fuse::Node_typeof()->Array();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[68/*Fuse.Node[]*/], offsetof(Visual__SafeIterator, _array), 0,
...
void Visual__SafeIterator::SecureCopy()
{
    if (_array == NULL)
    {
        ...
        {
            _array = uArray::New(::TYPES[68/*Fuse.Node[]*/], uPtr(_v)->_childCount - _pos);
            int i = 0;
...
{
    ::TYPES[69] = ::g::Fuse::IScalingMode_typeof();
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[69/*Fuse.IScalingMode*/]), this);
}
...
{
    ::TYPES[70] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[71] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL)->Array();
    ::TYPES[72] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Fuse::UpdateStage_typeof(), offsetof(Stage, UpdateStage), 0,
        ::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Listeners), 0,
        ::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Onces), 0,
        ::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, OncesPending), 0,
        ::TYPES[71/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], offsetof(Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[70/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    UpdateStage = _updateStage;
    int queueCount = 6;
    PhaseDeferredActions = uArray::New(::TYPES[71/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], queueCount);

    for (int i = 0; i < queueCount; ++i)
        uPtr(PhaseDeferredActions)->Strong< ::g::Uno::Collections::Queue*>(i) = (::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[72/*Uno.Collections.Queue<Fuse.UpdateAction>*/]);
}
...
{
    ::TYPES[73] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[73/*Uno.Collections.List<Uno.UX.Template>*/], offsetof(TemplateSourceImpl, _templates), 0);
}
...
{
    if (_templates == NULL)
        _templates = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Uno.UX.Template>*/]));
...
static void Transform_build(uType* type)
{
    ...
    type->SetFields(15,
        ::TYPES[74/*Uno.Action<Fuse.Transform>*/], offsetof(Transform, MatrixChanged1), 0);
}
...
static void UpdateAction_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[76/*Fuse.IUpdateListener*/], offsetof(UpdateAction, update), 0);
}
...
static void UpdateListener_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[76/*Fuse.IUpdateListener*/], offsetof(UpdateListener, update), 0,
...
static void UpdateManager_build(uType* type)
{
    ...
    ::TYPES[48] = ::g::Uno::Exception_typeof();
    ::TYPES[79] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[48/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ::TYPES[77/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&UpdateManager::_stages_, uFieldFlagsStatic,
        ::TYPES[78/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[78/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[80/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[81/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[52/*"raise"*/], uDelegate::New(::TYPES[82/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[52] = uString::Const("raise");
    ::STRINGS[53] = uString::Const("UserEvent requires a Name");
    ::STRINGS[54] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.uno");
    ::STRINGS[55] = uString::Const("OnRooted");
    ::STRINGS[56] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[57] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.ScriptClass.uno");
    ...
    ::TYPES[83] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[84] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[85] = ::TYPES[6/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.UserEvent>*/, type, NULL);
    ::TYPES[86] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.UserEvent>*/, type, NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
        ::g::Uno::UX::Selector_typeof(),
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"UserEvent r...*/], __this, ::STRINGS[54/*"/usr/local/...*/], 206, ::STRINGS[55/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[59/*"Trying to R...*/], this, ::STRINGS[54/*"/usr/local/...*/], 252, ::STRINGS[60/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Raise must ...*/], n, ::STRINGS[57/*"/usr/local/...*/], 76, ::STRINGS[52/*"raise"*/], NULL);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[83/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[58/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[57/*"/usr/local/...*/], 83, ::STRINGS[52/*"raise"*/], NULL);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[84/*Uno.Collections.Dictionary<string, object>*/]);
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            for (UserEvent* ue = (UserEvent*)uPtr(v)->FirstChild(::TYPES[85/*Fuse.Visual.FirstChild<Fuse.UserEvent>*/]); ue != NULL; ue = (UserEvent*)uPtr(ue)->NextSibling(::TYPES[86/*Fuse.Node.NextSibling<Fuse.UserEvent>*/]))
...
static void UserEventArgs_build(uType* type)
{
    ...
    ::TYPES[59] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[87] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[88] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::UX::Selector_typeof());
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[61/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
    ...
    if (__this->Args() != NULL)
    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[87/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                {
                    ...
                    ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[88/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[88/*Uno.Collections.KeyValuePair<string, object>*/]));
                }
            }
            {
                enum1.Dispose(::TYPES[87/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            }
        }
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[80/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(__type, ::TYPES[27/*string*/], NULL), ::STRINGS[47/*"Parameter"*/], uDelegate::New(::g::Uno::Func1_typeof()->MakeType(__type, ::g::Uno::UX::Property1_typeof()->MakeType(::TYPES[27/*string*/], NULL), NULL), (void*)Visual__getParameterProperty_fn), uString::Const(".notNull().parseJson()")), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("onParameterChanged"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], NULL), (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("bringIntoView"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], NULL), (void*)Visual__bringIntoView_fn), 2)));
}
...
void Visual__OnArrangeMarginBox_fn(Visual* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    for (Visual* v = (Visual*)__this->FirstChild(::TYPES[64/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[65/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
    {
...
void Visual::AssignNaturalZOrder()
{
    ...
    for (Visual* v = (Visual*)FirstChild(::TYPES[64/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[65/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret9);
...
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    if (!IsRootingCompleted())
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret10);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret11), ret11))
        return;
...
void Visual::CancelInteractions(int how)
{
    ...
    if (how == 1)
        ...
        for (Visual* v = (Visual*)FirstChild(::TYPES[64/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)NextSibling(::TYPES[65/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
uArray* Visual::Children_GetCachedArray()
{
    ...
    uArray* nodes = uArray::New(::TYPES[68/*Fuse.Node[]*/], _childCount);
...
uArray* Visual::ComputeZOrder()
{
    ...
    if (_visualChildCount == 1)
        return uArray::Init<Visual*>(Visual_typeof()->Array(), 1, (Visual*)FirstChild(::TYPES[64/*Fuse.Visual.FirstChild<Fuse.Visual>*/]));
...
void Visual::ConcludePendingRemove()
{
    ...
    if (HasBit(268435456))
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Node>*/]), this, &ret16);
        SetBit1(268435456, false);
    }
}
...
{
    ::STRINGS[62] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[62/*"visual"*/]));
...
{
    ::STRINGS[63] = uString::Const("Wrapped Exception");
    type->SetFields(4);
}
...
{
    ctor_2(::STRINGS[63/*"Wrapped Exc...*/], inner);
}
