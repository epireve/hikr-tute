...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/JavaScriptCore/Array.uno
// --------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/JavaScriptCore/Context.uno
// ----------------------------------------------------------------------------------------
...
::JSValueRef Context::Unwrap1(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[4/*Fuse.Scripting.JavaScriptCore.Function*/]))
        return ::g::Fuse::Scripting::JavaScriptCore::JSObjectRef::GetJSValueRef((ind16 = uPtr(uCast< ::g::Fuse::Scripting::JavaScriptCore::Function*>(obj, ::TYPES[4/*Fuse.Scripting.JavaScriptCore.Function*/]))->_value, ind16));
...
{
    uArray* result = uArray::New(uObject_typeof()->Array(), uPtr(values)->Length());
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/JavaScriptCore/Function.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/JavaScriptCore/JavaScriptCore.uno
// -----------------------------------------------------------------------------------------------
            ...
            {
                {
                    ...
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], scriptRef), ::TYPES[2/*Uno.IDisposable*/]));
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], sourceRef), ::TYPES[2/*Uno.IDisposable*/]));
                    return __uno_retval;
                }
                {
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], sourceRef), ::TYPES[2/*Uno.IDisposable*/]));
    ...
    {
        {
            ...
            ::JSValueRef __uno_retval = result;
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], strRef), ::TYPES[2/*Uno.IDisposable*/]));
            return __uno_retval;
        }
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], strRef), ::TYPES[2/*Uno.IDisposable*/]));
...
::JSValueRef JSValueRef::MakeString1(::JSContextRef ctx, uString* str)
{
    if (::g::Uno::String::op_Equality(str, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[4/*"str"*/]));
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/JavaScriptCore/Object.uno
// ---------------------------------------------------------------------------------------
...
{
    ::STRINGS[5] = uString::Const("Object.CallMethod.name");
    ::TYPES[4] = ::g::Fuse::Scripting::JavaScriptCore::Function_typeof();
...
void Object__CallMethod_fn(Object* __this, uString* name, uArray* args, uObject** __retval)
{
    ...
    if (::g::Uno::String::op_Equality(name, NULL))
        U_THROW(::g::Uno::ArgumentException::New4(::STRINGS[5/*"Object.Call...*/]));
...
{
    ::JSObjectRef ind6;
    return *__retval = uIs(type, ::TYPES[4/*Fuse.Scripting.JavaScriptCore.Function*/]) && ::g::Fuse::Scripting::JavaScriptCore::JSValueRef::IsInstanceOfConstructor(::g::Fuse::Scripting::JavaScriptCore::JSObjectRef::GetJSValueRef((ind6 = __this->_value, ind6)), uPtr(__this->_context)->_context, uPtr(uCast< ::g::Fuse::Scripting::JavaScriptCore::Function*>(type, ::TYPES[4/*Fuse.Scripting.JavaScriptCore.Function*/]))->_value, uPtr(__this->_context)->_onError), void();
}
    ...
    {
        {
            ...
            uArray* result = uArray::New(::TYPES[5/*string[]*/], count);
