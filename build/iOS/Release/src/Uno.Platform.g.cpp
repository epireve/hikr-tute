...
void Displays::TickAll(::g::Uno::Platform::TimerEventArgs* args)
{
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[5/*Uno.Collections.List<Uno.Platform.Display>.Enumerator*/]))
            {
        ...
        {
            enum1.Dispose(::TYPES[5/*Uno.Collections.List<Uno.Platform.Display>.Enumerator*/]);
        }
    }
