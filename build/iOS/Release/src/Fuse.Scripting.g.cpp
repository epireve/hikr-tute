...
static void ObjectMirror_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Fuse::Scripting::ValueMirror_typeof();
    ::TYPES[13] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
{
    uPtr(o)->CallMethod(::STRINGS[33/*"on"*/], uArray::Init<uObject*>(::TYPES[16/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
{
    ::STRINGS[34] = uString::Const("this._raw_");
    ::STRINGS[35] = uString::Const("this._");
    ::STRINGS[36] = uString::Const(" (ScriptProperty)");
    ::STRINGS[37] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[38] = uString::Const("', ");
    ::STRINGS[39] = uString::Const("{");
    ::STRINGS[40] = uString::Const("get: function() { ");
    ::STRINGS[41] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[42] = uString::Const("if (");
    ::STRINGS[43] = uString::Const(" != obs) {");
    ::STRINGS[44] = uString::Const(" = obs;");
    ::STRINGS[45] = uString::Const(" = obs");
    ::STRINGS[46] = uString::Const(";");
    ::STRINGS[47] = uString::Const("}");
    ::STRINGS[48] = uString::Const("return ");
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Scripting::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[34/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[35/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[36/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[37/*"(function(c...*/], p->Name), ::STRINGS[38/*"', "*/]), ::STRINGS[39/*"{"*/]), ::STRINGS[40/*"get: functi...*/]), ::STRINGS[41/*"var obs = g...*/]), ::STRINGS[42/*"if ("*/]), rawField), ::STRINGS[43/*" != obs) {"*/]), rawField), ::STRINGS[44/*" = obs;"*/]), propField), ::STRINGS[45/*" = obs"*/]), p->Modifier), ::STRINGS[46/*";"*/]), ::STRINGS[47/*"}"*/]), ::STRINGS[48/*"return "*/]), propField), ::STRINGS[47/*"}"*/]), ::STRINGS[49/*"})"*/]), ::STRINGS[49/*"})"*/])), ::TYPES[28/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[50] = uString::Const(" (ScriptReadonlyProperty)");
    ::STRINGS[51] = uString::Const("(function(cl,propValue){Object.defineProperty(cl.prototype,'");
    ::STRINGS[52] = uString::Const("',");
    ::STRINGS[39] = uString::Const("{");
    ::STRINGS[53] = uString::Const("value: propValue,");
    ::STRINGS[54] = uString::Const("writable: false,");
    ::STRINGS[55] = uString::Const("enumerable: true,");
    ::STRINGS[56] = uString::Const("configurable: false");
    ::STRINGS[47] = uString::Const("}");
...
{
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(constant)->Name, ::STRINGS[50/*" (ScriptRea...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[51/*"(function(c...*/], uPtr(constant)->Name), ::STRINGS[52/*"',"*/]), ::STRINGS[39/*"{"*/]), ::STRINGS[53/*"value: prop...*/]), ::STRINGS[54/*"writable: f...*/]), ::STRINGS[55/*"enumerable:...*/]), ::STRINGS[56/*"configurabl...*/]), ::STRINGS[47/*"}"*/]), ::STRINGS[57/*");"*/]), ::STRINGS[49/*"})"*/])), ::TYPES[28/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[58] = uString::Const("replaceAllWithOrigin");
    ::TYPES[16] = uObject_typeof()->Array();
    type->SetFields(0,
...
void Observable__Subscription__ReplaceAllExclusiveOperation::Perform(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Object)->CallMethod(::STRINGS[58/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[16/*object[]*/], 2, (::g::Fuse::Scripting::Array*)uPtr(uPtr(Worker)->Context())->NewArray(NewValues), uBox<int>(::TYPES[55/*int*/], Origin)));
}
...
{
    ::STRINGS[59] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[60] = uString::Const(" provided");
    ::STRINGS[61] = uString::Const("require(): argument must be a string");
    ::STRINGS[62] = uString::Const("ux:");
    ::STRINGS[63] = uString::Const("require(): unable to resolve ux: prefixes: ");
    ::STRINGS[64] = uString::Const("require(): ux name not found: ");
    ::STRINGS[65] = uString::Const("require(): module not found: ");
    ::STRINGS[66] = uString::Const("JavaScript error in ");
    ::STRINGS[67] = uString::Const(" was fixed!");
    ::STRINGS[68] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.2/ScriptModule.Require.uno");
    ::STRINGS[69] = uString::Const("Require");
    ::STRINGS[70] = uString::Const(" line ");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[59/*"require(): ...*/], uBox<int>(::TYPES[55/*int*/], uPtr(args)->Length())), ::STRINGS[60/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[64/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[61/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        uString* uxPrefix = ::STRINGS[62/*"ux:"*/];

        if (::g::Uno::String::StartsWith(uPtr(id), ::STRINGS[62/*"ux:"*/]))
        {
            if (_rt == NULL)
                U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[63/*"require(): ...*/], id)));

            uObject* res;

            if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_rt), ::g::Uno::String::Substring(uPtr(id), uPtr<uString*>(::STRINGS[62/*"ux:"*/])->Length()), (void**)(&res), &ret2), ret2))
                return res;
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[66/*"JavaScript ...*/], path), ::STRINGS[67/*" was fixed!"*/]), this, ::STRINGS[68/*"/usr/local/...*/], 73, ::STRINGS[69/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[66/*"JavaScript ...*/], path), ::STRINGS[70/*" line "*/]), uBox<int>(::TYPES[55/*int*/], uPtr(e)->LineNumber())), ::STRINGS[71/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[68/*"/usr/local/...*/], 83, ::STRINGS[69/*"Require"*/], NULL);
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[59/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
            {
                ...
                argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[72/*", "*/], dep.Key(::TYPES[13/*Uno.Collections.KeyValuePair<string, object>*/])));
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[74] = uString::Const("Error message: ");
    ::STRINGS[75] = uString::Const("File name: ");
    ::STRINGS[76] = uString::Const("Line number: ");
    ::STRINGS[77] = uString::Const("Source line: ");
    ::STRINGS[78] = uString::Const("JS stack trace: ");
    ::TYPES[55] = ::g::Uno::Int_typeof();
    type->SetFields(4,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[77/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[78/*"JS stack tr...*/]);
...
{
    ::STRINGS[79] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    if (!uIs(owner, __this->__type->T(0)))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[79/*"ScriptPrope...*/]));
...
{
    ::STRINGS[80] = uString::Const("setValueWithOrigin");
    ::TYPES[15] = ::g::Fuse::Scripting::ScriptException_typeof();
    ::TYPES[16] = uObject_typeof()->Array();
    type->SetFields(0,
    ...
    {
        {
            ...
            uPtr(Object)->CallMethod(::STRINGS[80/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[16/*object[]*/], 2, newValue, uBox<int>(::TYPES[55/*int*/], Origin)));
        }
    }
