...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Attempt to register in inactive Master"), this, ::STRINGS[8/*"/usr/local/...*/], 118, uString::Const("Register"));
        return;
    }
...
{
    ::STRINGS[5] = uString::Const("The property ");
    ::STRINGS[6] = uString::Const(" of ");
    ::STRINGS[7] = uString::Const(" cannot be reliably animated because it does not provide an origin-setter. Animating this property may lead to visual glitches or inconsistencies.");
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.2/Mixer.uno");
    ::STRINGS[9] = uString::Const("GiveOriginSetterWarning");
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[5/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[6/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[7/*" cannot be ...*/]), this, ::STRINGS[8/*"/usr/local/...*/], 275, ::STRINGS[9/*"GiveOriginS...*/]);
    }
}
// }
...
static void RangeAdapterHelpers__cctor__fn(uType* __type)
{
    ...
    RangeAdapterHelpers::_valueName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"Value"*/]);
}
...
{
    ::STRINGS[11] = uString::Const("Resize started without a Target node");
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.2/Resize.uno");
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"Resize star...*/], r, ::STRINGS[12/*"/usr/local/...*/], 98, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Resize star...*/], r, ::STRINGS[12/*"/usr/local/...*/], 106, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
...
{
    ::STRINGS[15] = uString::Const("Unexpected size for attract: ");
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.2/Attract.uno");
...
void Attract__Subscription::NeedSim(int size)
{
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[15/*"Unexpected ...*/], uBox<int>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[16/*"/usr/local/...*/], 134, ::STRINGS[17/*"NeedSim"*/]);
        return;
    }
