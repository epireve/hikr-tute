...
// public HomePage(Fuse.Navigation.Router router) :44
...
// public HomePage New(Fuse.Navigation.Router router) :44
...
// public HomePage(Fuse.Navigation.Router router) [instance] :44
...
void HomePage::InitializeUX()
{
    ...
    HomePage__Template* temp5 = HomePage__Template::New2(this, this);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), temp5);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL)), temp6);
...
// public HomePage New(Fuse.Navigation.Router router) [static] :44
