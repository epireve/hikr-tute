// This file was generated based on /dev.local/hikr/build/iOS/Preview/cache/ux13/SplashPage.g.uno.
...
static void SplashPage_build(uType* type)
{
    ...
    type->SetFields(122,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(SplashPage, temp_eb3), 0,
...
void SplashPage::InitializeUX()
{
    ...
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::hikr_bundle::SplashPage49bc05f9()));
    ...
    temp3->Opacity(0.5f);
    temp3->Layer(1);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::hikr_bundle::nature69d04e3d()));
    ...
    temp8->Alignment(2);
    temp9->Value(::STRINGS[6/*"Get Out The...*/]);
    temp9->Alignment(2);
    temp9->Opacity(0.5f);
    temp10->Alignment(8);
