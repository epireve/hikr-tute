...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.2/Selected.uno
// ---------------------------------------------------------------
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Values` must be an IObservableArray"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.2/Selection.uno"), 394, uString::Const("set_Values"), NULL);
        return;
    }
...
static void SelectionEvent_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.2/Selected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.2/ToggleSelection.uno");
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.2/WhileSelected.uno
// --------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.2/WhileSelected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[4] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
