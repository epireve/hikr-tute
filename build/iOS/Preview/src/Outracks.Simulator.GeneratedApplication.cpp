// This file was generated based on /dev.local/hikr/build/iOS/Preview/preamble/$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("169.254.39.118");
    ::STRINGS[2] = uString::Const("172.20.10.7");
    ::STRINGS[3] = uString::Const("/dev.local/hikr/hikr.unoproj");
