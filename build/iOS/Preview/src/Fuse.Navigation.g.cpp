...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Activated.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationAnimations.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RoutePageProxy.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/INavigation.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/SwipeNavigate.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/ModifyRouteCommand.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/TriggerActions.uno
// ----------------------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/TriggerActions.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterPage.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DynamicLinearNavigation.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DirectNavigation.uno
// ------------------------------------------------------------------------
...
static void DirectNavigation_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DirectNavigation.uno");
...
void DynamicLinearNavigation__FuseNavigationISeekableNavigationSeek_fn(DynamicLinearNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DynamicLinearNavigation.uno"), 466, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
void DynamicLinearNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DynamicLinearNavigation.uno"), 171, uString::Const("GotoImpl"), NULL);
        return;
    }
...
void DynamicLinearNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DynamicLinearNavigation.uno"), 31, uString::Const("set_Motion"), NULL);
}
...
void DynamicLinearNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/DynamicLinearNavigation.uno"), 231, uString::Const("OnUpdated"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/EdgeNavigation.uno
// ----------------------------------------------------------------------
...
static void EdgeNavigation_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/EdgeNavigation.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/ExplicitNavigation.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/FindRouter.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterModify.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno
// ----------------------------------------------------------------------------
...
static void RouteModificationCommand__InnerSubscription_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/ModifyRouteCommand.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/PageBinding.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/IRouterOutlet.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Navigation.Locators.uno
// ---------------------------------------------------------------------------
...
static void Navigation_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Navigation.Locators.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Navigation.Events.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno
// ---------------------------------------------------------------------------
...
void NavigationPageProxy::ctor_1(uDelegate* ready, uDelegate* unready)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("NavigationPageProxy is not meant to be used directly, use specific navigation triggers"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno"), 145, ::STRINGS[32/*".ctor"*/]);
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Got an undesired ready event"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno"), 90, uString::Const("OnPageRootingCompleted"));
        return;
    }
...
void NavigationPageProxy::RootImpl(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Attempting rooting to null source"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno"), 46, uString::Const("RootImpl"));
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Unable to locate Page"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno"), 53, uString::Const("RootImpl"), NULL);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Something went wrong locating a Navigator"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/NavigationPageProxy.uno"), 70, uString::Const("RootImpl"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/PageData.uno
// ----------------------------------------------------------------
...
static void PageData_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/PageData.uno");
...
static void PageResourceBinding_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/PageBinding.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Route.uno
// -------------------------------------------------------------
...
int RoutePageProxy::GetLevel(uObject* sender)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected sender"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RoutePageProxy.uno"), 119, uString::Const("GetLevel"));
    return -1;
}
...
void Router::CancelNavigation()
{
    ...
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("No active navigation that can be cancelled"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 373, uString::Const("CancelNavigation"));
}
...
::g::Fuse::Navigation::RouterPageRoute* Router::GetRelativeRoute1(::g::Fuse::Node* from, ::g::Fuse::Navigation::RouterPageRoute* rel)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot calculate relative node if not rooted"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 655, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Did not find an outlet relative to the provided Node"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 662, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }
...
void Router::Modify1(int how, ::g::Fuse::Navigation::RouterPageRoute* route, int mode, uString* operationStyle)
{
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(uString::Const("PrepareBack does not support an explicit route"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 223, uString::Const("Modify"));

            ::g::Fuse::Navigation::RouterPageRoute* popRoute = GetHistoryRoute(1);

            if (popRoute == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("There is no history for PrepareBack"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 228, uString::Const("Modify"), NULL);
                return;
            }
...
void Router::Pop()
{
    ...
    if (route == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot pop() - history is empty"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 300, uString::Const("Pop"), NULL);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid outlet depth in prepare progress"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 354, uString::Const("SetPrepareProgress"));
        return;
    }
...
::g::Fuse::Navigation::RouterPageRoute* Router::SetRoute(::g::Fuse::Navigation::RouterPageRoute* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 394, uString::Const("SetRoute"), NULL);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 396, uString::Const("SetRoute"));
...
::g::Fuse::Navigation::RouterPageRoute* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::RouterPage* rootPage, ::g::Fuse::Navigation::RouterPageRoute* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange, bool canReuse)
{
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("No router outlet found to handle route: "), r), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 418, uString::Const("SetRouteImpl"));
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (pageVisual == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("SubRoute requested but outlet has no active path: "), r), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 494, uString::Const("SetRouteImpl"));
            return NULL;
        }
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` takes one argument"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 246, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` should be passed an object"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 253, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, uString::Const("relative")))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("Could not find an outlet from the `relative` node"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 278, uString::Const("Bookmark"), NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, uString::Const("path")))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 287, uString::Const("Bookmark"), NULL);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), p), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 295, uString::Const("Bookmark"), NULL);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("A `name` is required for the bookmark"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 308, uString::Const("Bookmark"), NULL);
        return;
    }
...
::g::Fuse::Visual* Router::FindRouterOutletPage(::g::Fuse::Node* from)
{
    ...
    while ((from != NULL) && (uPtr(from)->Parent() != NULL))
    {
        ...
        if (ro != NULL)
        {
            ...
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected request for RouterOutlet page"), from, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.uno"), 568, uString::Const("FindRouterOutletPage"));
        }
...
::g::Fuse::Navigation::RouterPageRoute* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.gotoRelative(): requires 1+ parameters"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 96, uString::Const("GetRelative"), NULL);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): must provide exactly 1 argument."), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 335, uString::Const("GetRoute"), NULL);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): argument must be a function."), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 341, uString::Const("GetRoute"), NULL);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goBack takes no parameters"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 141, uString::Const("GoBack"), NULL);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goto(): invalid route provided"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 45, uString::Const("Goto"), NULL);
}
...
void Router::Modify2(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` takes one argument"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 184, uString::Const("Modify"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` should be passed an object"), r, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/Router.ScriptClass.uno"), 191, uString::Const("Modify"), NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterCancelNavigation.uno
// ------------------------------------------------------------------------------
...
static void RouterCancelNavigation_build(uType* type)
{
    ...
    ::STRINGS[38] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
void RouterModify::ctor_2()
{
    ...
    ctor_1();
    ::g::Fuse::Diagnostics::UserWarning(uString::Const("RouterModify is deprecated. Use one of `ModifyRoute`, `GotoRoute` or `PushRoute` instead."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterModify.uno"), 94, ::STRINGS[32/*".ctor"*/]);
}
...
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::RouterPageRoute* route)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Router not ...*/], this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterModify.uno"), 211, uString::Const("PerformRoute"), NULL);
        return;
    }
...
static void RouterPageRoute_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterPage.uno");
...
bool RouterRequest::AddArgument(uString* name, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), name), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 101, uString::Const("AddArgument"), NULL);
        return false;
    }
...
bool RouterRequest::AddPath(uObject* value)
{
    ...
    if ((_flags & 1) == 1)
    {
        ...
        if (path == NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 59, uString::Const("AddPath"), NULL);
            return false;
        }
...
bool RouterRequest::MakeRequest(::g::Fuse::Navigation::Router* router)
{
    ...
    if (::g::Uno::String::op_Inequality(Bookmark, NULL))
    {
        if (targetRoute != NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("A path and bookmark cannot both be specified"), router, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 116, uString::Const("MakeRequest"), NULL);
            return false;
        }

        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(uPtr(router)->Bookmarks), Bookmark, (void**)(&targetRoute), &ret6), ret6))
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unknown bookmark: "), Bookmark), router, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 122, uString::Const("MakeRequest"), NULL);
            return false;
        }
    }
...
bool RouterRequest::ParseNVPComponent(uObject* value, ::g::Fuse::Navigation::RouterPageRoute** route)
{
    ...
    ::g::Fuse::Diagnostics::UserError(uString::Const("incompatible path component"), value, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 197, uString::Const("ParseNVPComponent"), NULL);
    return false;
}
...
bool RouterRequest::ValidateParameter(uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, it contains reference loops or is too large"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 205, uString::Const("ValidateParameter"), NULL);
        return false;
    }
    ...
    if (uIs(arg, ::g::Fuse::Scripting::Object_typeof()))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain Observables."), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 214, uString::Const("ValidateParameter"), NULL);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain functions."), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterRequest.uno"), 237, uString::Const("ValidateParameter"), NULL);
        return false;
    }
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 408, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Use a `NavigationMotion` and the `GotoDuration` property instead of `Navigation.Duration`"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 310, uString::Const("set_Duration"));
}
...
void StructuredNavigation::Easing(::g::Fuse::Animations::Easing* value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Use a `NavigationMotion` and the `GotoEasing` property instead of `Navigation.Easing`"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 301, uString::Const("set_Easing"));
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 117, uString::Const("GotoImpl"), NULL);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 44, uString::Const("set_Motion"), NULL);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/StructuredNavigation.uno"), 208, uString::Const("OnUpdated"));
        return;
    }
...
static void FindRouter__Subscription_build(uType* type)
{
    ...
    ::STRINGS[50] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/FindRouter.uno");
    ::STRINGS[32] = uString::Const(".ctor");
    ::TYPES[33] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[52] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/SwipeNavigate.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/VisualNavigation.uno
// ------------------------------------------------------------------------
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/VisualNavigation.uno");
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileNavigationTriggers.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileCanGoBack.uno
// ----------------------------------------------------------------------
...
static void WhileHistoryTrigger_build(uType* type)
{
    ...
    ::STRINGS[60] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileCanGoBack.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[16] = ::g::Fuse::Navigation::IBaseNavigation_typeof();
    ::TYPES[54] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
    type->SetDependencies(
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileNavigating.uno
// -----------------------------------------------------------------------
...
static void WhileNavigating_build(uType* type)
{
    ...
    ::STRINGS[62] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileNavigating.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[56] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
...
// /usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhilePageActive.uno
// -----------------------------------------------------------------------
...
static void WhilePageActive_build(uType* type)
{
    ...
    ::STRINGS[64] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhilePageActive.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[24] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    type->SetDependencies(
