...
{
    ::STRINGS[9] = uString::Const("StringWriter");
    ::STRINGS[5] = uString::Const("buffer");
...
void StringWriter__Write1_fn(StringWriter* __this, uChar* value)
{
    ...
    if (!__this->_open)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[9/*"StringWriter"*/]));
...
static void TextWriter_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(30,
        ...
        new uFunction("Flush", NULL, (void*)TextWriter__Flush_fn, 0, false, uVoid_typeof(), 0),
        ...
        new uFunction("Write", NULL, (void*)TextWriter__Write9_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
...
// public void Write(string value) :82
...
// public void Write(string value) [instance] :82
void TextWriter::Write9(uString* value)
{
    uStackFrame __("Uno.IO.TextWriter", "Write(string)");

    if (::g::Uno::String::op_Inequality(value, NULL))
        Write2(::g::Uno::String::ToCharArray(uPtr(value)));
}
