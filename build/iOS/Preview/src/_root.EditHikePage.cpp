// This file was generated based on /dev.local/hikr/build/iOS/Preview/cache/ux13/EditHikePage.g.uno.
...
static void EditHikePage_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("Rating (1-5):");
    ...
    type->SetFields(122,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(EditHikePage, temp_eb1), 0,
...
void EditHikePage::InitializeUX1()
{
    ...
    temp_Value_inst = ::g::hikr_FuseControlsTextInputControl_Value_Property::New1(temp, EditHikePage::__selector0_);
    ...
    ::g::Fuse::Reactive::DataBinding* temp21 = ::g::Fuse::Reactive::DataBinding::New1(temp_Value_inst, (uObject*)temp7, 3);
    ::g::Fuse::Controls::StackPanel* temp22 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::TitleText* temp23 = ::g::TitleText::New5();
    ::g::Fuse::Reactive::DataBinding* temp24 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp8, 3);
    ...
    ::g::Fuse::Reactive::DataBinding* temp30 = ::g::Fuse::Reactive::DataBinding::New1(temp3_Value_inst, (uObject*)temp10, 3);
    ::g::Fuse::Controls::StackPanel* temp31 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::TitleText* temp32 = ::g::TitleText::New5();
    ::g::Fuse::Reactive::DataBinding* temp33 = ::g::Fuse::Reactive::DataBinding::New1(temp4_Value_inst, (uObject*)temp11, 3);
    temp12->LineNumber(3);
    temp12->FileName(::STRINGS[11/*"Pages/EditH...*/]);
    temp12->File(::g::Uno::UX::BundleFileSource::New1(::g::hikr_bundle::EditHikePage90aa522b()));
    ...
    temp29->Value(::STRINGS[17/*"Rating (1-5):"*/]);
    temp3->InputHint(4);
