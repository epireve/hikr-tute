// This file was generated based on /dev.local/hikr/build/iOS/Preview/cache/ux13/hikr.Page.g.uno.
...
void Page::InitializeUX()
{
    ...
    temp->Opacity(0.7f);
    temp->Layer(1);
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::hikr_bundle::background6d136236()));
