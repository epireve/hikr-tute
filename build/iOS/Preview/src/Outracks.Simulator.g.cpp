                            ...
                            {
                                {
                                    ...
                                    for (int i = 0; i < endpoints->Length(); i++)
                                    {
                                        ...
                                        int simulatorPort = reader->ReadInt32();
...
void ObjectIdentifier::ctor_1(uString* document, int tagIndex)
{
    ...
    _string = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(document, ::STRINGS[26/*"#"*/]), uBox<int>(::TYPES[4/*int*/], tagIndex));
    Document = document;
}
...
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 0, ::STRINGS[27/*"/usr/local/...*/], 246);
    }
}
...
void TextOffset__ToString_fn(TextOffset* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition1(::STRINGS[33/*"@"*/], uBox<int>(::TYPES[4/*int*/], __this->_offset)), void();
}
...
::g::Outracks::Simulator::TextPosition TextOffsetConversion::ToPosition(::g::Outracks::Simulator::TextOffset* offset, uString* data)
{
    ...
    uArray* lines = ::g::Uno::String::Split(uPtr(::g::Uno::String::Replace1(uPtr(data), ::STRINGS[34/*"\r"*/], ::STRINGS[31/*""*/])), uArray::Init<int>(::TYPES[46/*char[]*/], 1, 10));
