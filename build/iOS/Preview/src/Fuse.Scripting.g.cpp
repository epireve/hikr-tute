...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.2/NativeEvent.uno");
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[76] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.2/ScriptModule.Require.uno");
