// This file was generated based on /dev.local/hikr/build/iOS/Preview/cache/ux13/hikr.TextBox.g.uno.
...
static void TextBox_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::TextInput_type, interface10),
...
void TextBox::InitializeUX1()
{
    ...
    TextColor(::g::Fuse::Drawing::Colors::White_);
    CaretColor(::g::Fuse::Drawing::Colors::White_);
