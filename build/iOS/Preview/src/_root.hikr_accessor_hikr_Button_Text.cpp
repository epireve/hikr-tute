...
// {
// static generated hikr_accessor_hikr_Button_Text() :1
...
static void hikr_accessor_hikr_Button_Text_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::UX::PropertyAccessor_typeof(), (uintptr_t)&hikr_accessor_hikr_Button_Text::Singleton_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&hikr_accessor_hikr_Button_Text::_name_, uFieldFlagsStatic);
}
...
{
    return *__retval = hikr_accessor_hikr_Button_Text::_name_, void();
}
