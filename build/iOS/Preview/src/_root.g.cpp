...
{
    FuseScriptingJavaScript_bundle::Diagnosticsaebd3a87_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[179/*"Fuse.Script...*/]))->GetFile(::STRINGS[180/*"diagnostics...*/]);
    FuseScriptingJavaScript_bundle::es6promiseminf61a2dae_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[179/*"Fuse.Script...*/]))->GetFile(::STRINGS[181/*"es6-promise...*/]);
    FuseScriptingJavaScript_bundle::Observable414f1520_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[179/*"Fuse.Script...*/]))->GetFile(::STRINGS[182/*"observable-...*/]);
    FuseScriptingJavaScript_bundle::setTimeoutde16bf26_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[179/*"Fuse.Script...*/]))->GetFile(::STRINGS[183/*"settimeout-...*/]);
}
...
static void FuseScriptingJavaScript_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(4,
        new uField("Diagnosticsaebd3a87", 0),
        new uField("es6promiseminf61a2dae", 1),
        new uField("Observable414f1520", 2),
        new uField("setTimeoutde16bf26", 3));
}
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.2/.uno/package
// ----------------------------------------------------------
