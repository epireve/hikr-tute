...
static void PlayTo_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Actions/Playback.uno");
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.2/NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Actions/TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Actions/Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.2/Triggers/LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Action_typeof();
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Actions/StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Actions/TriggerAction.uno");
