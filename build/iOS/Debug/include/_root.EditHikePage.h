// This file was generated based on /dev.local/hikr/.uno/ux13/EditHikePage.g.uno.
...
struct EditHikePage : ::g::Fuse::Controls::Page
{
    ...
    void InitializeUX();
    static EditHikePage* New5(::g::Fuse::Navigation::Router* router1);
};
// }
