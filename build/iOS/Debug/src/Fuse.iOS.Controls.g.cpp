...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.4.2/iOS/WebView.uno
// -------------------------------------------------------------------------
...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/1.4.2/iOS/WebView.uno");
