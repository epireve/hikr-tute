...
{
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/DebugLog.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder- ToString(), 0, ::STRINGS[6/*"/usr/local/...*/], 53);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)- Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)- Strong<uObject* (i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)- Strong<uObject* (i))) : ::STRINGS[7/*"null"*/], 0, ::STRINGS[6/*"/usr/local/...*/], 39);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.2/DataBinding.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())- PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e- ToString(), Target(), ::STRINGS[26/*"/usr/local/...*/], 317, ::STRINGS[28/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
{
    for (int i = 0; i < uPtr(args)- Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)- Strong<uObject* (i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)- Strong<uObject* (i))) : ::STRINGS[7/*"null"*/], 0, ::STRINGS[6/*"/usr/local/...*/], 17);
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("too many parameters for "), ::g::Uno::UX::Selector__op_Implicit1(__this- _item)), __this, ::STRINGS[36/*"/usr/local/...*/], 34, uString::Const("Subscribe"), NULL);
        return *__retval = NULL, void();
    }
...
static void InstantiatorFunction__InstantiatorSubscription_build(uType* type)
{
    ...
    ::STRINGS[36] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.2/InstantiatorFunction.uno");
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"invalid sea...*/], this, ::STRINGS[36/*"/usr/local/...*/], 92, ::STRINGS[37/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Could not f...*/], this, ::STRINGS[36/*"/usr/local/...*/], 99, ::STRINGS[37/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[39/*"Unable to r...*/], this, ::STRINGS[36/*"/usr/local/...*/], 110, ::STRINGS[37/*"OnNewNode"*/]);
        return;
    }
...
static void ObserverMap_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/1.4.2/ObserverMap.uno");
...
void ObserverMap::Attach(uObject* src, uObject* slave)
{
    ...
    if (_observable != NULL)
    {
        ...
        if (_subscription == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"An observab...*/], this, ::STRINGS[47/*"/usr/local/...*/], 68, ::STRINGS[48/*"Attach"*/]);
    }
