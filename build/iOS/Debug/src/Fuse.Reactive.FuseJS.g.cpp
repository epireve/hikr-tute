...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promiseminf61a2dae())->ReadAllText());
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], ::STRINGS[6/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnosticsaebd3a87()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observable414f1520()))->EvaluateExports(context, ::STRINGS[8/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/DiagnosticsImpl.uno");
