...
{
    ProgressChanged1 = uCast<uDelegate* (::g::Uno::Delegate::Combine(ProgressChanged1, value), ::TYPES[42/*Uno.UX.ValueChangedHandler`1*/]- MakeType(::g::Uno::Double_typeof(), NULL));
}
...
{
    ProgressChanged1 = uCast<uDelegate* (::g::Uno::Delegate::Remove(ProgressChanged1, value), ::TYPES[42/*Uno.UX.ValueChangedHandler`1*/]- MakeType(::g::Uno::Double_typeof(), NULL));
}
...
{
    ::TYPES[35] = ::g::Fuse::Input::FocusGainedHandler_typeof();
    ::TYPES[36] = ::g::Fuse::Input::FocusLostHandler_typeof();
    type- SetDependencies(
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this- Parent(), uDelegate::New(::TYPES[35/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this- Parent(), uDelegate::New(::TYPES[36/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
...
{
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this- Parent(), uDelegate::New(::TYPES[35/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this- Parent(), uDelegate::New(::TYPES[36/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
{
    ::TYPES[32] = ::g::Uno::Bool_typeof();
    ::TYPES[37] = ::g::Fuse::Visual_typeof()- MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePaused */, type, NULL);
    ::TYPES[38] = ::g::Fuse::Node_typeof()- MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePaused */, type, NULL);
    type- SetInterfaces(
        ::g::Uno::Collections::IList_typeof()- MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void WhilePaused::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        ...
        for (WhilePaused* wl = (WhilePaused*)n- FirstChild(::TYPES[37/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePaused */]); wl != NULL; wl = (WhilePaused*)uPtr(wl)- NextSibling(::TYPES[38/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePaused */]))
            uPtr(wl)- SetActive(paused);
    }
}
// }
...
{
    ::TYPES[32] = ::g::Uno::Bool_typeof();
    ::TYPES[39] = ::g::Fuse::Visual_typeof()- MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePlaying */, type, NULL);
    ::TYPES[40] = ::g::Fuse::Node_typeof()- MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePlaying */, type, NULL);
    type- SetInterfaces(
        ::g::Uno::Collections::IList_typeof()- MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void WhilePlaying::SetState(::g::Fuse::Visual* n, bool playing)
{
    ...
    if (v != playing)
    {
        ...
        for (WhilePlaying* wl = (WhilePlaying*)n- FirstChild(::TYPES[39/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePlaying */]); wl != NULL; wl = (WhilePlaying*)uPtr(wl)- NextSibling(::TYPES[40/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePlaying */]))
...
static void WhileValue_build(uType* type)
{
    ...
    type- SetFields(37,
        ...
        ::TYPES[41/*Fuse.Triggers.IValue`1*/]- MakeType(type- T(0), NULL), offsetof(WhileValue, _source), 0,
        ::TYPES[41/*Fuse.Triggers.IValue`1*/]- MakeType(type- T(0), NULL), offsetof(WhileValue, _obj), 0,
        ::TYPES[42/*Uno.UX.ValueChangedHandler`1*/]- MakeType(type- T(0), NULL), offsetof(WhileValue, ValueChanged1), 0);
}
