...
static void RouterCancelNavigation_build(uType* type)
{
    ...
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(8,
...
void RouterCancelNavigation__Perform_fn(RouterCancelNavigation* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Router not ...*/], __this, ::STRINGS[34/*"/usr/local/...*/], 20, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::RouterPageRoute* route)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Router not ...*/], this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterModify.uno"), 211, uString::Const("PerformRoute"), NULL);
        return;
    }
...
static void RouterPageRoute_build(uType* type)
{
    ...
    ::STRINGS[43] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/RouterPage.uno");
...
RouterPageRoute* RouterPageRoute::SubDepth(int count)
{
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[42/*"count can't...*/], this, ::STRINGS[43/*"/usr/local/...*/], 196, ::STRINGS[44/*"SubDepth"*/]);
        return NULL;
    }
...
static void FindRouter__Subscription_build(uType* type)
{
    ...
    ::STRINGS[46] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/FindRouter.uno");
...
void FindRouter__Subscription::ctor_(::g::Fuse::Navigation::FindRouter* expr, ::g::Fuse::Node* origin, uObject* listener)
{
    ...
    if (router == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"unable to f...*/], this, ::STRINGS[46/*"/usr/local/...*/], 49, ::STRINGS[47/*".ctor"*/], NULL);
    else
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[49] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/SwipeNavigate.uno");
...
void SwipeNavigate__FuseInputIGestureOnPointerPressed_fn(SwipeNavigate* __this, ::g::Fuse::Input::PointerPressedArgs* args, int* __retval)
{
    ...
    if (__this->_currentNavigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"SwipeNaviga...*/], __this, ::STRINGS[49/*"/usr/local/...*/], 230, ::STRINGS[50/*"Fuse.Input....*/]);
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::STRINGS[54] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/VisualNavigation.uno");
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Navigation....*/], nav, ::STRINGS[54/*"/usr/local/...*/], 30, ::STRINGS[55/*"gotoNode"*/], NULL);
}
// }
...
static void WhileNavigating_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.4.2/WhileNavigating.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[46] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
