...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[33/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[55/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[56/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[57/*"height"*/], (double)NewSize().Y);
}
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[61] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.uno");
    ...
    ::STRINGS[64] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.ScriptClass.uno");
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[59/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[68/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
static void VisualEvent_build(uType* type)
{
    ...
    ::STRINGS[70] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Event.uno");
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[69/*"Invalid Rai...*/], 0, ::STRINGS[70/*"/usr/local/...*/], 105);
            return;
        }
    }
